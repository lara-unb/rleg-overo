...
\begin{DoxyCompactList}\small\item\em Print A\-L\-L sensors data. \end{DoxyCompactList}\item 
int \hyperlink{ui_8c_a9f6b336147c82460bbe9e5e324cd4936}{ui\-\_\-control} (C\-O\-N\-T\-R\-O\-L\-\_\-\-D\-A\-T\-A\-\_\-\-S\-T\-R\-U\-C\-T $\ast$pcontrol\-\_\-data)
...
\hypertarget{ui_8c_a9f6b336147c82460bbe9e5e324cd4936}{\index{ui.\-c@{ui.\-c}!ui\-\_\-control@{ui\-\_\-control}}
\index{ui\-\_\-control@{ui\-\_\-control}!ui.c@{ui.\-c}}
\subsubsection[{ui\-\_\-control}]{\setlength{\rightskip}{0pt plus 5cm}int ui\-\_\-control (
\begin{DoxyParamCaption}
\item[{C\-O\-N\-T\-R\-O\-L\-\_\-\-D\-A\-T\-A\-\_\-\-S\-T\-R\-U\-C\-T $\ast$}]{pcontrol\-\_\-data}
\end{DoxyParamCaption}
)}}\label{ui_8c_a9f6b336147c82460bbe9e5e324cd4936}
...
\begin{DoxyCode}
\{
    mvprintw(2, 0, \textcolor{stringliteral}{"Roll Gain:   %3.2lf"}, pcontrol\_data->roll\_proportional\_gain
      );
    mvprintw(3, 0, \textcolor{stringliteral}{"Pitch Gain:  %3.2lf"}, pcontrol\_data->
      pitch\_proportional\_gain);
    mvprintw(4, 0, \textcolor{stringliteral}{"Yaw Gain:    %3.2lf"}, pcontrol\_data->yaw\_proportional\_gain)
      ;

    mvprintw(24, 0, \textcolor{stringliteral}{"1: Roll +"});
    mvprintw(25, 0, \textcolor{stringliteral}{"2: Roll -"});
    mvprintw(26, 0, \textcolor{stringliteral}{"3: Pitch +"});

    mvprintw(24, 40, \textcolor{stringliteral}{"4: Pitch -"});
    mvprintw(25, 40, \textcolor{stringliteral}{"5: Yaw +"});
    mvprintw(26, 40, \textcolor{stringliteral}{"6: Yaw -"});

    \textcolor{keywordflow}{return} UI\_SUCCESS;
\}*/
\end{DoxyCode}
...
\{
      ...
      \hyperlink{structIMU__DATA__STRUCT_aeffe3c3c5a7191a5cef16e7aab6c3795}{calib}.\hyperlink{structIMU__DATA__STRUCT_1_1calibrated_a2fde6c6759e0fda17e272c32096cb9ec}{mag}.\hyperlink{structDATA__XYZ__DOUBLE_a9556e8868c223ff3e28756ea18a284c0}{z});
        mvprintw(11, 0, \textcolor{stringliteral}{"Encoder (rad):\(\backslash\)t%d"}, enc\_data->\hyperlink{structENC__DATA__STRUCT_ad25beb30fd5b975292f87db02ec9930a}{angle});

        mvprintw(13, 0, \textcolor{stringliteral}{"Temp (bits):\(\backslash\)t%d"}, pimu\_data->\hyperlink{structIMU__DATA__STRUCT_a81e1dbf765c1d947ca6076aa1bbc73e7}{temp});
        mvprintw(13,40, \textcolor{stringliteral}{"Temp (ºC):\(\backslash\)t%lf"}, pimu\_data->\hyperlink{structIMU__DATA__STRUCT_a3553fcee6beba17fe0c7711ac0483875}{calib\_temp});

        mvprintw(15,0,\textcolor{stringliteral}{"Fx (bits): %d"},peff\_data->\hyperlink{structEFF__DATA__STRUCT_abe8952947b54bf9c247f3429ee3aeb44}{F}.\hyperlink{structDATA__XYZ_a54c1596e9f9969fd9c21e8458024ecfb}{x});
        \textcolor{comment}{//mvprintw(2,40,"Fx (N): %lf",peff\_data->??);}
        ...
        mvprintw(17, 0, \textcolor{stringliteral}{"Voltage Control Written (bits):\(\backslash\)t%4d"}, pmra\_data->\hyperlink{structMRA__DATA__STRUCT_a64b4e6bb604e58de593a60c87942b966}{
      v\_ctl});
        mvprintw(18, 0, \textcolor{stringliteral}{"Voltage Control Read (bits):\(\backslash\)t%4d"}, pmra\_data->
      \hyperlink{structMRA__DATA__STRUCT_a3a31d57268c33b21ac915fdc27dfe474}{v\_ctl\_read});

    mvprintw(20, 0, \textcolor{stringliteral}{"Runtime: %4.2lf"}, t);
    ...
    \{
        mvprintw(20, 40, \textcolor{stringliteral}{"Datalogger stopped"});
    \}
    \textcolor{keywordflow}{else}
    \{
        mvprintw(20, 40, \textcolor{stringliteral}{"Datalogger runtime: %4.2lf"}, (t-t0));
    \}
\textcolor{comment}{/*}
...
\textcolor{comment}{    \}}
\textcolor{comment}{*/}
        mvprintw(22, 0, \textcolor{stringliteral}{"I: IMU"});
        mvprintw(22, 20, \textcolor{stringliteral}{"F: Efforts"});
        mvprintw(22, 40, \textcolor{stringliteral}{"M: Magneto-rheological Actuator"});
        mvprintw(23, 0, \textcolor{stringliteral}{"E: Encoder"});
        mvprintw(23, 20, \textcolor{stringliteral}{"O: Overview"});
        mvprintw(23, 40, \textcolor{stringliteral}{"D: Datalogger Start/Stop"});
        mvprintw(24, 0, \textcolor{stringliteral}{"Q: Quit"});
